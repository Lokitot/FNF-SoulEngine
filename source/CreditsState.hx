...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color     (Goofy note: if you don't want to put a link in your credits just put "nolink" in the link section, alr see ya)
			...
			['Ney',			        'ney',			    'Composed the freaky menu theme\nEmotional support <3',		    'https://www.youtube.com/channel/UCqZ59PQjVb0Nuvp1lHpawSQ',			'D334D3'],
			[''],
			['Soul Engine Contributors'],
			['Erizur',		        'erizur',		    'Coded the Platform Utils and System Stuff',			    	'https://twitter.com/am_erizur',	        'FFFFFF'],
			['Chromasen',		    'unknown',	        'Coded the Platform Utils',								    	'nolink',	                                'FFFFFF'],
			[''],
			['Engine Beta Testers'],
			['Machine',				'machine',			'Beta tester',		                                            'https://www.youtube.com/channel/UC045PmoI2qb8qwmcn83UMNQ',			'404040'],
			[''], 
			['Psych Engine Team'],
